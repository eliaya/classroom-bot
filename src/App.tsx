                          ...
                          <div className="space-y-4">
                            ...
                            <div className="space-y-1">
                              ...
                              <div className="bg-slate-950 rounded-lg p-3 font-mono text-xs text-emerald-400 border border-slate-800 flex items-center justify-between select-all leading-relaxed">
                                ...
                                <button 
                                  onClick={() => { navigator.clipboard.writeText("docker compose -f docker-compose.dev.yml up -d --build"); triggerNotification("📋 Command Copied!"); }}
                            ...
                            <div className="space-y-1">
                              ...
                              <div className="bg-slate-950 rounded-lg p-3 font-mono text-xs text-emerald-400 border border-slate-800 flex items-center justify-between select-all leading-relaxed">
                                ...
                                <button 
                                  onClick={() => { navigator.clipboard.writeText("docker compose -f docker-compose.dev.yml logs -f bot"); triggerNotification("📋 Command Copied!"); }}
                                  className="text-slate-500 hover:text-emerald-400 shrink-0"
                                >
                                  <Copy className="w-3.5 h-3.5" />
                                </button>
                            ...
                            <div className="space-y-1">
                              ...
                              <div className="bg-slate-950 rounded-lg p-3 font-mono text-xs text-emerald-400 border border-slate-800 flex items-center justify-between select-all leading-relaxed">
                                <code className="truncate pr-4 flex-1">
                                  docker compose -f docker-compose.dev.yml exec web sh -c "wget -qO- http://127.0.0.1:5173/ | grep -E '&lt;title&gt;|src/main'"
                                </code>
                                <button 
                                  onClick={() => { navigator.clipboard.writeText("docker compose -f docker-compose.dev.yml exec web sh -c \"wget -qO- http://127.0.0.1:5173/ | grep -E '<title>|src/main'\""); triggerNotification("📋 Command Copied!"); }}
                                  className="text-slate-500 hover:text-emerald-400 shrink-0"
                                >
                                  <Copy className="w-3.5 h-3.5" />
                                </button>
